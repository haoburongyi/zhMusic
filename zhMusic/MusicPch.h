 ...
 *  随机色
 */
#define ZYRandomColor ZYARGBColor(arc4random_uniform(256), arc4random_uniform(256), arc4random_uniform(256),arc4random_uniform(256))

/**
 *  屏幕比
 */
#define ZYSCaleW(x) mainScreenW * (x / 375.0)
#define ZYSCaleH(x) mainScreenH * (x / 667.0)
